...
class Renderer: NSObject, MTKViewDelegate {
    ...
    class func buildRenderPipelineWithDevice(device: MTLDevice,
        ...
        //        psd.alphaBlendOperation =control.add
        //        psd.rgbBlendOperation =control.add
        //        psd.sourceRGBBlendFactor =control.sourceAlpha
        //        psd.sourceAlphaBlendFactor =control.sourceAlpha
        //        psd.destinationRGBBlendFactor =control.oneMinusSourceAlpha
        //        psd.destinationAlphaBlendFactor =control.oneMinusSourceAlpha
    ...
    func draw(in view: MTKView) {
        ...
        uniforms[0].light.x = sinf(lightAngle) * 50
        uniforms[0].light.z = cosf(lightAngle) * 50
        uniforms[0].light.y = 0
        lightAngle += 0.01
